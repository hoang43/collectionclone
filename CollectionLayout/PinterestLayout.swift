...
class PinterestLayout: UICollectionViewLayout {
    ...
    fileprivate var store = [UICollectionViewLayoutAttributes]()
    ...
    override func prepare() {
      guard store.isEmpty, let collectionView = collectionView else {
        return
      }
